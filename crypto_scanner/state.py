...
import json
# timezone.utc e nao datetime.UTC: o alias UTC so existe a partir do
# Python 3.11, e a VM do GCP vem com Ubuntu 22.04 / Python 3.10. Nos
# workflows do GitHub usava-se 3.12, por isso o problema nunca aparecia.
